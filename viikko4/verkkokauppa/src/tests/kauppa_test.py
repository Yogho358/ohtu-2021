...
class TestKauppa(unittest.TestCase):
    ...
    def test_ostoskorissa_kaksi_ostosta(self):
    ...
    def test_ostoskorissa_kaksi_samaa_ostosta(self):
    ...
    def test_yritetaan_ostaa_loppunutta(self):
    ...
    def test_aloita_asiointi_nollaa_tiedot(self):
        ...
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(2)
        self.kauppa.tilimaksu("matti", "33555")

        self.pankki_mock.tilisiirto.assert_called_with("matti", 42, "33555", "33333-44455", 7)
